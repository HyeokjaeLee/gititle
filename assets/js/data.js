const emojiList = [
    ...
    { content: "⬆️", description: "Update to higher version dependencies" },
    { content: "⬇️", description: "Update to lower version dependencies" },
    { content: "📌", description: "Update to fixed version dependencies" },
    ...
    { content: "✏️", description: "Correct typos." },
